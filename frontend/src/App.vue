<template>
    <div>
        ...
        <q-layout view="lHh Lpr lFf">
            ...
            <q-drawer v-model="leftDrawerOpen" show-if-above bordered :width="240" class="bg-dark text-white">
                <q-scroll-area class="fit">
                    <!-- <q-item-label header class="text-weight-bold text-accent flex flex-center">
                            Sports Hub
                        </q-item-label> -->
                    <q-list padding class="">
                        <q-item-label header class="text-weight-bold text-accent " style="font-size: 1.5rem;">
                            <q-icon name="sports_score" size="md" class="q-mr-sm" />
                            Sports Hub
                        </q-item-label>

                        <q-separator color="accent" class="q-mb-sm" />

                        <q-item v-for="nav in navItems" :key="nav.title" clickable v-ripple :to="nav.to" exact
                            class="q-my-xs">
                        ...
                        <div class="q-pa-md">
                            ...
                            <q-item v-for="fav in favoriteTeams" :key="fav.id" clickable
